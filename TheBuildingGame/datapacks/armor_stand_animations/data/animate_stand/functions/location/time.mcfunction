...
execute if score @s cas_movpose matches 1 run function animate_stand:location/time/1
execute if score @s cas_movpose matches 2 run function animate_stand:location/time/2
execute if score @s cas_movpose matches 3 run function animate_stand:location/time/3
execute if score @s cas_movpose matches 4 run function animate_stand:location/time/4
execute if score @s cas_movpose matches 5 run function animate_stand:location/time/5
