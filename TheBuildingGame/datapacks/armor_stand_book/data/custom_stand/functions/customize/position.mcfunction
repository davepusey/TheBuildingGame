execute as @e[type=armor_stand,tag=!Moving,distance=..50] if score @s cas_uuidleast_q = @p[tag=casSelected] cas_uuidleast_q if score @s cas_uuidmost_q = @p[tag=casSelected] cas_uuidmost_q run tag @s add casTemp
...
scoreboard players operation br cas_rot = @s zcas_click
...
execute if score @s zcas_click matches 37..40 run function custom_stand:customize/position/1
execute if score @s zcas_click matches 43..46 run function custom_stand:customize/position/4
execute if score @s zcas_click matches 49..52 run function custom_stand:customize/position/16
execute if score @s zcas_click matches 53 rotated as @e[type=armor_stand,tag=casTemp,limit=1] positioned as @s align xyz positioned ~0.5 ~ ~0.5 run tp @e[type=armor_stand,tag=casTemp,limit=1] ~ ~ ~
execute if score @s zcas_click matches 54 run function custom_stand:customize/position/teleport
