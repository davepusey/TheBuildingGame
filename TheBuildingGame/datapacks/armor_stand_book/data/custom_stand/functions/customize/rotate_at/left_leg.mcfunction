...
execute if entity @s[nbt={Small:0b}] positioned ^0.1 ^0.8 ^ run summon area_effect_cloud ~ ~ ~ {Tags:["casRotation"]}
execute if entity @s[nbt={Small:1b}] positioned ^0.05 ^0.4 ^ run summon area_effect_cloud ~ ~ ~ {Tags:["casRotation"]}
