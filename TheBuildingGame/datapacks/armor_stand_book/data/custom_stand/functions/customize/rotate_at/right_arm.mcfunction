...
execute if entity @s[nbt={Small:0b}] positioned ^-0.3 ^1.4 ^ run summon area_effect_cloud ~ ~ ~ {Tags:["casRotation"]}
execute if entity @s[nbt={Small:1b}] positioned ^-0.15 ^0.7 ^ run summon area_effect_cloud ~ ~ ~ {Tags:["casRotation"]}
