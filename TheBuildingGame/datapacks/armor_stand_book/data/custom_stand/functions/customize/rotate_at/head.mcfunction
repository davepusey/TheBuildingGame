...
execute if entity @s[nbt={Small:0b}] positioned ^ ^1.6 ^ run summon area_effect_cloud ~ ~ ~ {Tags:["casRotation"]}
execute if entity @s[nbt={Small:1b}] positioned ^ ^0.8 ^ run summon area_effect_cloud ~ ~ ~ {Tags:["casRotation"]}
