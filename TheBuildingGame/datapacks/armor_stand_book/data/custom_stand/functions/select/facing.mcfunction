...
execute positioned ^ ^ ^20 as @e[type=armor_stand,distance=..25] run function custom_stand:select/check_position
execute as @e[type=armor_stand,tag=casTemp,limit=1,sort=nearest] run function custom_stand:select/uuid
