...
scoreboard players set @s zcas_click 30
...
tellraw @p[tag=casTemp] ["",{"translate":"Selected armor stand at ","color":"green"},{"text":"[","color":"green"},{"score":{"name":"x","objective":"cas_rot"},"color":"green"},{"text":", ","color":"green"},{"score":{"name":"y","objective":"cas_rot"},"color":"green"},{"text":", ","color":"green"},{"score":{"name":"z","objective":"cas_rot"},"color":"green"},{"text":"].","color":"green"}]
